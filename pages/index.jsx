  ...
  return (
    <motion.section exit={{ opacity: 0 }} className="bg-stone-800">
      ...
      >
        ...
        <Clients baseVelocity={1} margin="mb-12 lg:mb-24">Goridar Grupa d.o.o. 144 Kuk Sul Do Zagreb Tring Energetika d.o.o. Rigeta d.o.o. Župić&partneri d.o.o.</Clients>
        <AnimatedHeading
          className="w-full text-3xl text-right lg:text-5xl p-8 lg:p-24"
          text="Selected works"
        />
