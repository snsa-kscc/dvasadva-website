...
const Contact = () => {
  return (
    <div className="h-[70vh] bg-teal-500 flex flex-wrap justify-center items-center p-8 lg:p-16 gap-20">
      <div className="basis-80 grow"><p className={`text-3xl md:text-5xl xl:text-6xl 2xl:text-8xl text-zinc-200 ${spaceMono700.className}`}>Interested in what you see?</p></div>
